:root {
        ...
        /* .hidden previously came ONLY from the Tailwind CDN. If that CDN is slow or blocked,
           every modal would flash open at once. Defined locally so hiding never depends on it. */
        ...
        #info-modal-default .info-meta p { margin: 0.35rem 0; }
        #info-modal-default .info-label {
            font-weight: 700;
            color: var(--secondary-color);
        }
        #info-modal-default .info-para { margin-bottom: 1rem; text-align: right; }
        #info-modal-default .info-subhead {
            font-weight: 700;
            margin-bottom: 0.5rem;
            text-align: right;
        }
        #info-modal-default .info-list {
            list-style: none;
            padding: 0;
            margin: 0 0 1.25rem 0;
        }
        #info-modal-default .info-list li {
            position: relative;
            padding-right: 1.75rem;
            margin-bottom: 0.75rem;
            text-align: right;
        }
        #info-modal-default .info-list li::before {
            content: "★";
            position: absolute;
            right: 0;
            top: 0;
        ...
        @media (max-width: 600px) {
            #info-modal-body { max-height: 55vh; }
            #info-modal-default { font-size: 0.95rem; line-height: 1.9; }
        }
        ...
        #media-library-modal .vocab-card { cursor: pointer; }
        #media-library-modal .vocab-card h3 { font-size: 1rem; word-break: break-all; }
        .upload-container {
            display: grid;
        ...
        /* START: Mobile Responsiveness Adjustments */
        @media (max-width: 600px) {
            #game-page .container {
                padding-left: 0.5rem;
            ...
            #inventory-display {
                padding: 0.4rem;
                gap: 0.5rem;
                flex-grow: 0; /* Don't allow it to grow too much */
            ...
            #activity-container .btn:not(#activity-header .btn) {
                font-size: 1rem;
        ...
        /* END: Mobile Responsiveness Adjustments */
